<%-- 
    Document   : index
    Created on : Feb 25, 2016, 10:48:15 PM
    Author     : Fpt
--%>
...
<body>
	<header>
						...
						<div class="pull-right">
							<ul class="list-unstyled top-links">
                                                            ...
                                                            <li><h4><a href="listCourse.html">List Course</a></h4></li>
                                                                ...
                                                                <li><h4><a href="homePageCL.jsp">Sign in</a></h4></li>
		...
		<div class="main-header">
			<div class="container">
            <div class="row">
                <div class="col-md-4"> <a href="#"><img src="./templates/img/logo.jpg" /></a>  
			...
			<div class="container">
				<div class="row" style="text-align:center">
					<ul class="nav nav-pills">
						...
						<li><a href="listPrograming.html">Programing</a></li>
						<li><a href="listAllAppCMR.html">News</a></li>
	...
	<section class="content">
		<div class="container">
			...
			<div class="new-lists">
				<div class="row">
					<div class="col-sm-12">
						<h3 class="centerBox" style="background-color:red; text-align:center">News</h3>
					</div>
				</div>
				<div class="row">
