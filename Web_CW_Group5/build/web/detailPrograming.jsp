<%-- 
    Document   : detailPrograming
    Created on : Mar 1, 2016, 10:26:24 AM
    Author     : Fpt
--%>
...
<html>
    ...
    <body>
        ...
        <section class="content">
            <div class="col-sm-12">
                    <h3 style="background-color:red; text-align:center"> ${requestScope.Department.departmentName} </h3>
                </div>
            <div class="container">                
                
                    <c:forEach items="${requestScope.listCou}" var="cou">
                <div class="panel panel-default">
                    <div class="panel-heading">${cou.title} - ${cou.courseId}</div>
                    <div class="panel-body">
                        <h4>Course Leader: ${cou.courseLeader}</h4>
                        <h4>SEM: ${cou.semester}</h4>
                        <h4>Course Unit: ${cou.courserUnits}</h4>
                        <h4>Course Duration:  ${cou.costUnit}</h4>
                    </div>
                </div>
                </c:forEach>
