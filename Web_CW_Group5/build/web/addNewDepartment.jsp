        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    ...
                    <h2 class="sub-header">Department</h2>
                    ...
                    <div class="table-responsive">
                        ...
                        <center>
                            ...
                            <form action="AddNewDepartment">
                                <table class="table" border="1">                                  
                                        <td><b>Programing Name:</b></td>
                                        <td>
                                            <input type="text" name="department" value="${param.department}"/>
                                            <span style="color: red">${requestScope.deErr}</span>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="submit" class="btn btn-default navbar-btn">Add</button>
