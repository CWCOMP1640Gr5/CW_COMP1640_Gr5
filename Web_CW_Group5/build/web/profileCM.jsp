<%-- 
    Document   : profileCM
    Created on : Mar 16, 2016, 10:59:01 AM
    Author     : Fpt
--%>
        ...
        <section class="content">
            <div class="container">
                ...
                <div class="new-lists">
                    <div class="row">
                        <div class="col-sm-12">
                            <h3 class="box-title" style="background-color:#2aabd2; text-align:center">PROFILE</h3>
                        </div>

                        <div class="panel panel-default">
                            <!-- Default panel contents -->
                            <div class="panel-heading">User Name: ${requestScope.AccountCM.userName}</div>
