<%-- 
    Document   : viewAppCMRForDirector
    Created on : Mar 20, 2016, 2:42:31 PM
    Author     : Fpt
--%>
                                ...
                                <table class="table" style="width: 70%">
                                    ...
                                    <tr>
                                     ...
                                     <tr>
                                        <td>Comment:</td>
                                        <td colspan="11">
                                            <textarea name="txtComment" style="width: 100%;height: 250%" readonly="true">${requestScope.CMR.commentContent}</textarea>
                                        </td> 
                                    </tr>
                                </table>
                                <br/>
