        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    ...
                    <h2 class="sub-header">Course Detail</h2>
                    ...
                    <div class="table-responsive">
                       ...
                       <ul class="list-group">
                            <li class="list-group-item"><h3>Course: ${requestScope.Cou.courseId} </h3></li>
                            <li class="list-group-item">Title:  ${requestScope.Cou.title}</li>
                            <li class="list-group-item">Description: ${requestScope.Cou.description}</li>
   
                            <li class="list-group-item"><a href="ListCourseAdmin">Back</a></li>
