<%-- 
    Document   : listApprovedCMR
    Created on : Mar 20, 2016, 2:23:53 PM
    Author     : Fpt
--%>
        ...
        <section class="content">
            <div class="container">
                ...
                <div class="new-lists">
                    <div class="row">
                        <div class="col-sm-12">
                            <h3 class="box-title" style="background-color:#2aabd2; text-align:center">Approved Course Monitor Report</h3>
                            ...
                            <div class="panel panel-default">
                                ...
                                <table class="table">
                                    ...
                                    <c:forEach items="${requestScope.ListAppCMR}" var="cmr">
                                        <tr>
                                            <td>${cmr.CMRId}</td>
                                            ...
                                            <td>${cmr.startDate}</td>
                                            <td>
                                                <a href="ViewAppCRMForDirector?CMRId=${cmr.CMRId}">View</a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </table>
