        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    ...
                    <h2 class="sub-header">List Course </h2>
                        ...
                        <table  class="table table-striped" border="1">
                            ...
                            <c:forEach items="${requestScope.listCou}" var="co">
                                <tr>
                                    <td>${co.courseId}</td>
                                    <td>${co.title}</td>
                                    <td colspan="2"><a href="DetailCourseAdmin?courseId=${co.courseId}">View</a>  |  <a href="PreUpdateCourse?courseId=${co.courseId}">Update</a>| <a onclick="return confirm('Are you sure want to delete Courser :${co.courseId}')" href="DeleteCourse?courseId=${co.courseId}">Delete</a></td>
                                </tr>
                            </c:forEach>
