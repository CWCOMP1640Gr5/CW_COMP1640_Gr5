        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    ...
                    <h2 class="sub-header">List Department</h2>
                    ...
                    <div class="table-responsive">
                        <table  class="table table-striped" border="1">
                            ...
                            <c:forEach items="${requestScope.listDe}" var="de">
                                <tr>
                                    <td>${de.departmentId}</td>
                                    <td>${de.departmentName}</td>
                                    <td colspan="2"> <a onclick="return confirm('Are you sure want to delete Department :${de.departmentId}')" href="DeleteDepartment?departmentId=${de.departmentId}">Delete</a></td>
                                </tr>
                            </c:forEach>
