        ...
        <section class="content">
            <div class="container">
                ...
                <div class="new-lists">
                    ...
                    <c:forEach items="${requestScope.ListCMR}" var="cmr">
                        <div class="new-lists">
                            <div class="row">                     

                                <div class="list-group">
                                    <a href="DetailCmr?CMRId=${cmr.CMRId}" class="list-group-item active">
                                        <h4 class="list-group-item-heading">Academic ${cmr.academicSession}</h4>
                                        <p class="list-group-item-text">Course Leader: ${cmr.courseLeader}</p>
                                        <p class="list-group-item-text">Title: ${cou.cmr.title}</p>
                                        <p class="list-group-item-text"> Start Date: ${cmr.startDate}</p>
                                    </a>
                                </div>
