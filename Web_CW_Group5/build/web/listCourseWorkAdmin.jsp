        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    ...
                    <h2 class="sub-header">List Course Work</h2>
                        ...
                        <table  class="table table-striped" border="1">
                            ...
                            <c:forEach items="${requestScope.listCou}" var="co">
                                <tr>
                                    ...
                                    <td>${co.yearMaking}</td>
                                    <td>${co.courserUnits}</td>
                                    <td colspan="2"><a href="DetailCourseWorkAdmin?courseWorkId=${co.courseWorkId}">View</a>  |  <a href="PreUpdateCourseWork?courseWorkId=${co.courseWorkId}">Update</a>| <a onclick="return confirm('Are you sure want to delete CourserWork :${co.courseWorkId}')" href="DeleteCourseWork?courseWorkId=${co.courseWorkId}">Delete</a></td>
                                </tr>
                            </c:forEach>
