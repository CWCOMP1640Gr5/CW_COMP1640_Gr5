                            ...
                            <form action="createCMR" method="GET">
                                <table border="1">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input required type="number" name="academicsession" />
                                        </td>
                                    </tr>
                                    <%
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select name="coursecode"> 
                                                <c:forEach var="searchResult" items="${listcourse}">
                                                    <option  value="${searchResult.courseId}"> ${searchResult.title} </option> 
                                                </c:forEach>
                                            </select>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>Course Leader:</td>
                                        <td>
                                            <input required type="text" name="courseleader" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Student count</td>
                                        <td>
                                            <input required type="number" name="studentcounnt" />
                                        </td>
                                    </tr>                                   
                                </table>
                                <br/>
