 ...
 * @author Fpt
 */
@WebServlet(name = "LoadHomeCM", urlPatterns = {"/LoadHomeCM"})
public class LoadHomeCM extends HttpServlet {
...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet LoadHomeCM</title>");            
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet LoadHomeCM at " + cmName + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
//        }
    }
