 ...
 * @author Fpt
 */
@WebServlet(name = "DeleteCourseWork", urlPatterns = {"/DeleteCourseWork"})
public class DeleteCourseWork extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean result = new CourseWorkDAO().deleteCourse(courseWorkId);
        
        if(result == true)
        {
            request.setAttribute("deleteStatus", "Delete success Course:"+ courseWorkId);
