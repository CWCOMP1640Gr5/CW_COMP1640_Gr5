 ...
 * @author Fpt
 */
@WebServlet(name = "ViewAppCRMForDirector", urlPatterns = {"/ViewAppCRMForDirector"})
public class ViewAppCRMForDirector extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("viewAppCMRForDirector.jsp").forward(request, response);
...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet ViewAppCRMForDirector</title>");            
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet ViewAppCRMForDirector at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
//        }
    }
