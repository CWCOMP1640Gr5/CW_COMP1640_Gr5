 ...
 * @author Fpt
 */
@WebServlet(name = "CommentAppCRMForDirector", urlPatterns = {"/CommentAppCRMForDirector"})
public class CommentAppCRMForDirector extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        CourseMonitorReportDAO cmr = new CourseMonitorReportDAO().getCMRByCMRId(cmrId);
        ...
        request.getRequestDispatcher("commentAppCMRForDirector.jsp").forward(request, response);
...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet CommentAppCRMForDirector</title>");            
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet CommentAppCRMForDirector at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
//        }
    }
