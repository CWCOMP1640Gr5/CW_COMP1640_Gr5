 ...
 * @author Fpt
 */
@WebServlet(name = "ListAllCMRForCM", urlPatterns = {"/ListAllCMRForCM"})
public class ListAllCMRForCM extends HttpServlet {
...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet ListAllCMRForCM</title>");            
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet ListAllCMRForCM at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
//        }
    }
