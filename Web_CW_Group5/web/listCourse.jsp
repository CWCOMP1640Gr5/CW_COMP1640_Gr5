<%-- 
    Document   : listCourse
    Created on : Feb 29, 2016, 9:00:00 PM
    Author     : Fpt
--%>
...
<html>
    ...
    <body>
        ...
        <section class="content">
            <div class="container">                
                <div class="col-sm-12">
                    <h3 style="background-color:red;font-family: fantasy; text-align:center">List Course</h3>
                </div>
                .
                <c:forEach items="${requestScope.listCou}" var="cou">
                    <div class="new-lists">
                        <div class="row">                     

                            <div class="list-group">
                                <a href="DetailCourse?courseWorkId=${cou.courseWorkId}" class="list-group-item active">
                                    <h4 class="list-group-item-heading">Year: ${cou.yearMaking}</h4>
                                    <p class="list-group-item-text">Course Leader: ${cou.courseLeader}</p>
                                    <p class="list-group-item-text">Course Moderator: ${cou.courserModerator}</p>
                                    <p class="list-group-item-text"> SEM: ${cou.semester}</p>
                                </a>
                            </div>
