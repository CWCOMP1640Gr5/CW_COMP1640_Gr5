<%-- 
    Document   : listCMRNewForCM
    Created on : Mar 15, 2016, 9:35:21 PM
    Author     : Fpt
--%>
    ...
    <body>
        ...
        <section class="content">
            ...
            <div id="exTab2" class="container">	
                ...
                <form action="ApprovedCMR?CMRId=${cmrDetail.CMRId}" >
                    <div class="tab-content ">
                        <div class="tab-pane active" id="1">

                            <div class="panel panel-blue margin-bottom-40">
                                <div class="panel-body">
                                    <input hidden="true" name="txtCmrId" value="${cmrDetail.CMRId}" />
                        ...
                        <div class="col-sm-4">
                            <input value="APPROVE" type="submit" class="btn btn-warning" onclick="return confirm('Are you sure to Approve this CMR?')" />
                            <input value="CANCEL" class="btn btn-warning" onclick="window.location = 'homePageForCM.jsp';" type="button" />
                        </div>
                    </div>
                </form>
