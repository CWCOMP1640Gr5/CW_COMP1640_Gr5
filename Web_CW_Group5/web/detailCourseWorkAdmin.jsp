        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    ...
                    <h2 class="sub-header">CourseWork Detail</h2>
                    ...
                    <div class="table-responsive">
                       ...
                       <ul class="list-group">
                            <li class="list-group-item"><h3>Course: ${requestScope.Course.courseId} - ${requestScope.Cou.title} </h3></li>
                            <li class="list-group-item">Programing: ${requestScope.NamePro}</li>
                            <li class="list-group-item">Course Leader: ${requestScope.Course.courseLeader}</li>
                            <li class="list-group-item">Course Moderator: ${requestScope.Course.courserModerator}</li>
                            <li class="list-group-item">Start Date:  ${requestScope.Course.createDate}</li>
                            <li class="list-group-item">Year Making:  ${requestScope.Course.yearMaking}</li>
                            <li class="list-group-item">SEM: ${requestScope.Course.semester}</li>
                            <li class="list-group-item">Student Count: ${requestScope.Course.studentCount}</li>
                            <li class="list-group-item">Cost Duration: ${requestScope.Course.costUnit}</li>
                            <li class="list-group-item">Course Unit: ${requestScope.Course.courserUnits}</li>
                            <li class="list-group-item">isHadCMR: ${requestScope.Course.ishadCMR}</li>
                            <li class="list-group-item"><a href="ListCourseWorkAdmin">Back</a></li>
