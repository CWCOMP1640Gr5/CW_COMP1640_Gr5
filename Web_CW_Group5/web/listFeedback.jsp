        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    ...
                    <h2 class="sub-header">List FeedBack</h2>
                        ...
                        <table  class="table table-striped" border="1">
                            ...
                            <c:forEach items="${requestScope.ListFeedBack}" var="fb">
                                <tr>
                                    ...
                                    <td>${fb.title}</td>
                                    <td>${fb.timePost}</td>
                                    <td>${fb.statusFeedBack?"Readed":"Un Read"}</td>
                                    <td colspan="2"><a href="DetailFeedBack?feedBackId=${fb.feedBackId}">View</a>  | <a onclick="return confirm('Are you sure want to delete FeedBack :${fb.feedBackId}')" href="DeleteFeedBack?feedBackId=${fb.feedBackId}">Delete</a></td>
                                </tr>
                            </c:forEach>
