<%-- 
    Document   : listAllCMRForCM
    Created on : Mar 19, 2016, 6:06:13 PM
    Author     : Fpt
--%>
                ...
                <div class="new-lists">
                    <div class="row">
                        ...
                        <div class="panel panel-default">
                            ...
                            <form action="SearchCMRForCM">
                                <div class="input-group pull-left">
                                    <select name="Action">
                                        <option selected="selected" value="">Search For...</option>
                                        <option value="Approved">Approved</option>
                                        <option value="CreateNew">UnApproved</option>
                                    </select>
                            ...
                            <table class="table">
                                ...
                                <c:forEach var="cmr" items="${requestScope.ListCMR}">
                                    <tr>
                                        <td>${cmr.CMRId}</td>
                                        ...
                                        <td>${cmr.startDate}</td>
                                        <td>
                                            <a href="ViewCRMForCM?CMRId=${cmr.CMRId}">View</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </table>
