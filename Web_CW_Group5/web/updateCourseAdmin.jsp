        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    ...
                    <h2 class="sub-header">Update Course :${requestScope.Course.courseId}</h2>
                    ...
                    <div class="table-responsive">
                        ...
                        <form action="UpdateCourse">
                            <table class="table" border="1">
                                <tr>
                                    <td style="width: 14%"><span class="input-group-addon" id="basic-addon1">ID</span></td>
                                    <td>
                                        <input type="text" name="txtcourseId" class="form-control" aria-describedby="basic-addon1" value="${requestScope.Course.courseId}" readonly="true">
                                    </td>
                                </tr>
                                <tr>
                                    <td><b><span class="input-group-addon" id="basic-addon1">Title</span></b></td>
                                    <td>
                                        <input required="required" type="text" name="txtTitle" value="${requestScope.Course.title}" class="form-control" aria-describedby="basic-addon1">
                                        
                                    </td>
                                </tr>
                                <tr>
                                    <td><b><span class="input-group-addon" id="basic-addon1">Description</span></b></td>
                                    <td >
                                        <textarea name="txtdescription" required="required" style="height: 150px;width: 90%">${requestScope.Course.description}</textarea>
